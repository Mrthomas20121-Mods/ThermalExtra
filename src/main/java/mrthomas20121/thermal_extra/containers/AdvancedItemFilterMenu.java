...
public class AdvancedItemFilterMenu extends ContainerMenuCoFH implements IFilterOptions {
    ...
    public AdvancedItemFilterMenu(int windowId, Level world, Inventory inventory, Player player, int holder, int id, BlockPos pos) {
        ...
        super(ThermalExtraContainers.ADVANCED_ITEM_FILTER_CONTAINER.get(), windowId, inventory, player);
