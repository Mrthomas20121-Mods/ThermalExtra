...
public class ThermalExtraBlocks {
    ...
    public static RegistryObject<Item> DRYING_TANK = registerAugmentableBlock("drying_tank", () -> new EntityBlockActive4Way(of().sound(SoundType.NETHERITE_BLOCK).strength(2.0F).lightLevel(lightValue(ACTIVE, 0)), MachineDryingTankBlockEntity.class, ThermalExtraBlockEntities.DRYING_TANK), () -> ThermalCoreConfig.machineAugments, MACHINE_VALIDATOR, ThermalExtra.MOD_ID);
