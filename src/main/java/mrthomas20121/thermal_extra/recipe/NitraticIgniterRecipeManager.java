...
public class NitraticIgniterRecipeManager extends AbstractManager implements IRecipeManager, CatalyzedRecipeManager {
    ...
    protected Map<NitraticIgniterMapWrapper, IMachineRecipe> recipeMap = new Object2ObjectOpenHashMap<>();
    ...
    protected IMachineRecipe getRecipe(List<? extends IItemStackHolder> inputSlots, List<? extends IFluidStackHolder> inputTanks) {
        ...
        IMachineRecipe ret = recipeMap.get(new NitraticIgniterMapWrapper(convertedItems));
        ...
        if (ret == null) {
            ...
            ret = recipeMap.get(new NitraticIgniterMapWrapper(convertedItems));
        }
        return ret;
    }
    ...
    protected IMachineRecipe addRecipe(int energy, float experience, List<ItemStack> inputItems, List<FluidStack> inputFluids, List<ItemStack> outputItems, List<Float> chance, List<FluidStack> outputFluids, BaseMachineRecipe.RecipeType type) {
        ...
        recipeMap.put(new NitraticIgniterMapWrapper(convertedItems), recipe);
        return recipe;
    }
    // endregion
    ...
    public void refresh(RecipeManager recipeManager) {
        ...
        clear();
        var recipes = recipeManager.getAllRecipesFor(ThermalExtraRecipeTypes.NITRATIC_IGNITER.get());
        for (var entry : recipes) {
            addRecipe(entry, BaseMachineRecipe.RecipeType.CATALYZED);
        }
        var catalysts = recipeManager.getAllRecipesFor(ThermalExtraRecipeTypes.NITRATIC_IGNITER_CATALYST.get());
    ...
    protected static class NitraticIgniterMapWrapper {

        Set<Integer> itemHashes;
        int hashCode;

        NitraticIgniterMapWrapper(List<ComparableItemStack> itemStacks) {
        ...
        public boolean equals(Object o) {
            ...
            NitraticIgniterMapWrapper that = (NitraticIgniterMapWrapper) o;
