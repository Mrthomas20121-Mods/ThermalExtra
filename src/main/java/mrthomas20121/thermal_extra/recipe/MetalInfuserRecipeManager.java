...
public class MetalInfuserRecipeManager extends AbstractManager implements IRecipeManager {
    ...
    private static final MetalInfuserRecipeManager INSTANCE = new MetalInfuserRecipeManager();
    ...
    public static MetalInfuserRecipeManager instance() {

        return INSTANCE;
    }

    private MetalInfuserRecipeManager() {
    ...
    public void refresh(RecipeManager recipeManager) {
        ...
        clear();
        var recipes = recipeManager.getAllRecipesFor(ThermalExtraRecipeTypes.METAL_INFUSER.get());
